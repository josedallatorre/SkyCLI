...
The first part of the analysis focuses on verifying how many messages has been successfully received. The pie chart of the message outcome per test appears in figure number \ref{fig:pie_chart_received_mgs}. \\
\begin{figure}[h]
