...
\end{figure}
\\
Since the tests were manual it's necessary to consider that the sender and the receiver weren't synchronized. The messages that were sent before the receiver was ready won't be considered as errors but will be considered as a category per se instead. \\
Given this assumption the plot highlight that only one message in the second test was invalid. 
Remember that there are 5 errors in sender. 1 in 1 2 3 and 2 in 5
\newpage
\appendix
\newpage
